...
#define LOGODELAY 2000  //Logo will bw shown for this time period   
...
{
  time_t t = t_unix;    //declaration and initialization of structure  
  setTime(t);           
  String hourString, minuteString, secondString, timeString;
  String monthString, dayString, yearString, dateString;
  // digital clock display of human readable time and date
  // Making a single stirng of time
  ...
  //Making a single stirng of date
  ...
  display.clear();  
  display.display();                               //Refreshing screen
  display.setFont(ArialMT_Plain_16);
  display.setTextAlignment(TEXT_ALIGN_RIGHT);
  display.drawString(128, 45, dateString);        //Displaying date 
  display.drawString(128, 30, timeString);        //Displaying time
  display.display();
}
